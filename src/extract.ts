...
import {
  expandShortlinksInExtract,
  type ResolveShortlinkOptions,
  type ShortlinkExpansion,
} from "./shortlinks.js";
import { isAllowedPublicHttpUrl } from "./urlSafety.js";
...
export interface ExtractResult {
  ...
  shortlink_expansions?: ShortlinkExpansion[];
  chapters?: Array<{
    title: string;
    start_time: number;
